...
var cfgFile string
var servers, dbuser, password, db, rs string
...
func init() {
	...
	viper.BindPFlag("dbuser", RootCmd.Flags().Lookup("dbuser"))
...
func initConfig() {
	if cfgFile != "" { // enable ability to specify config file via flag
		fmt.Println("Parsing and using config file: ", cfgFile)
		viper.SetConfigFile(cfgFile)
	}

	viper.SetConfigName(".pax-mongo") // name of config file (without extension)
